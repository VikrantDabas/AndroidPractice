...
public class DisplayYear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(movies.size() < 0){
            Toast.makeText(this, "No Movies have been Added!", Toast.LENGTH_SHORT).show();
            finish();
        }
        else {
            position = 0;
        ...
        findViewById(R.id.firstYear).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.nextYear).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(position == movies.size()-1){
                    Toast.makeText(DisplayYear.this, "Already at last position.", Toast.LENGTH_SHORT).show();
                    return;
                }
                position++;
                sb.clear();
        ...
        findViewById(R.id.previousYear).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(position == 0){
                    Toast.makeText(DisplayYear.this, "Already at first position.", Toast.LENGTH_SHORT).show();
                    return;
                }
                sb.clear();
                position--;
        ...
        findViewById(R.id.buttonFinishYear).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
